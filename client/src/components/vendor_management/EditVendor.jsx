...
export default function EditVendor({ vendor, onBack, onSave }) {
  ...
  const [form, setForm] = useState({
    ...
    exchangeRate: vendor?.exchangeRate || "1.00",
  });
  ...
  return (
    <div className="max-w-[1200px] mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-[18px] font-bold text-slate-900">Edit Vendor</h1>
