...
import { ArrowLeft, Save, Package, Calendar, MapPin, Truck } from 'lucide-react';
...
export default function SupplierReturnForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      setLoading(false);
      alert('Supplier Return entry created successfully!');
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-[18px] font-extrabold text-slate-900 tracking-tight">Add Supplier Return</h1>
            <p className="text-[11px] text-slate-500 font-semibold">Record new supplier return entry</p>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Section title="Supplier & Return Details" icon={Truck}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Field label="Original GRN No">
              <input type="text" name="originalGrnNo" value={form.originalGrnNo} onChange={handleChange} placeholder="e.g. GRN-2026-101" className={inputCls} />
            </Field>
            ...
            <Field label="Product Condition" required>
              <select name="condition" value={form.condition} onChange={handleChange} className={inputCls} required>
                ...
                <option value="Good">Good - Returnable</option>
              </select>
            </Field>
