...
import { ArrowLeft, Save, Package, Calendar, MapPin, FileText, Truck } from 'lucide-react';
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-[18px] font-extrabold text-slate-900 tracking-tight">Add Stock Out</h1>
            <p className="text-[11px] text-slate-500 font-semibold">Record new stock outgoing entry</p>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Section title="Customer & Document Details" icon={FileText}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Field label="Sales Order No">
              <input type="text" name="salesOrderNo" value={form.salesOrderNo} onChange={handleChange} placeholder="e.g. SO-2026-001" className={inputCls} />
            </Field>
            <Field label="Invoice No">
              <input type="text" name="invoiceNo" value={form.invoiceNo} onChange={handleChange} placeholder="e.g. INV-2026-160" className={inputCls} />
            </Field>
            ...
            <Field label="Reason for Stock Out" required>
              <select name="reason" value={form.reason} onChange={handleChange} className={inputCls} required>
